...
SECRET_KEY = 'django-insecure-x6w$)fe-761)chd!y^#rrw%=ij@d8n#h!*eiin_t0&c010cog('
...
ROOT_URLCONF = 'third_website.urls'
...
WSGI_APPLICATION = 'third_website.wsgi.application'
